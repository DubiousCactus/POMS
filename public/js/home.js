...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
	...
	$('#add-basket').click(function () {
		...
		if ($(this).data('ispizza')) {
			...
			var htmlContent = '<strong>Size:</strong><br><br>' + '<input type="radio" name="size" value="0" checked>Normal&nbsp;&nbsp;&nbsp;&nbsp;' + '<input type="radio" name="size" value="1">Family<br><br><br>' + '<strong>Toppings:</strong><br><br>';
